...
export function AdminSettingsPage() {
  ...
  const load = useCallback(async () => { setLoading(true); setLoadError(null); try { const value = await rainApi.fetchAdminSettings(); setAllowed(value.allow_registration); } catch (e) { setLoadError(normalizeApiError(e)); } finally { setLoading(false); } }, []);
